...
class _ReferScreenState extends State<ReferScreen> {
  ...
  void initState() {
    super.initState();
    // Fetch user profile when screen loads if not already loaded
  ...
  void _shareRefer(String referCode) {
    final String message =
        'Join E-SportsBD and earn rewards! Use my referral code: $referCode\nDownload the app from here: https://e-sportsbd.top';
    ...
    return Scaffold(
      ...
      body: Consumer<ProfileProvider>(
        builder: (context, profileProvider, child) {
          ...
          final referCode =
              profileProvider.profileData?.user.referralCode ?? '';
