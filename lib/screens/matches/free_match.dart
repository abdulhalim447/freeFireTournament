...
class FreeMatchScreen extends StatefulWidget {
  final String matchType;
  final String image;

    const FreeMatchScreen({Key? key, required this.matchType, required this.image})
    : super(key: key);

  @override
  State<FreeMatchScreen> createState() => _FreeMatchScreenState();
}

class _FreeMatchScreenState extends State<FreeMatchScreen> {
  ...
  Future<void> _fetchMatchData() async {
    ...
    final response = await NetworkCaller.getRequest(URLs.FreeMatchUrl);
