...
class _BRMatchScreenState extends State<BRMatchScreen> {
  ...
  Widget _buildMatchCard(Matches match, bool isSmallScreen) {
    ...
    final int filledSlots = match.joined ?? 0;
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: ElevatedButton(
                            onPressed:
                                match.registration?.toLowerCase() == 'open'
                                    ? () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
          ...
          child: Column(
            ...
            children: [
              ...
              if (match.totalPrizeDetails != null &&
                ...
                _buildDetailRow(
                  'Prize Details:',
                  match.totalPrizeDetails!,
                  isSmallScreen,
                )
              else if (match.detailes != null && match.detailes!.isNotEmpty)
                _buildDetailRow('Details:', match.detailes!, isSmallScreen),
              const SizedBox(height: 20),
              SizedBox(
                width: double.infinity,
                child: ElevatedButton(
